import{isNotDefined as e,isNotString as t,isEmptyString as r,isBlankString as s,isArray as n,isString as i,isObject as o,isFunction as a,isDefined as u,isNull as c,isUndefined as l,isNotBoolean as d,isEmptyArray as h,isEmptyObject as p,isNotArray as g,isNotObject as f}from"itee-validators";import{TAbstractObject as _}from"itee-core";import E from"path";import*as m from"buffer";import b from"fs";import{Writable as y}from"stream";var v,x=new Uint8Array(16);function w(){if(!v&&!(v="undefined"!=typeof crypto&&crypto.getRandomValues&&crypto.getRandomValues.bind(crypto)||"undefined"!=typeof msCrypto&&"function"==typeof msCrypto.getRandomValues&&msCrypto.getRandomValues.bind(msCrypto)))throw new Error("crypto.getRandomValues() not supported. See https://github.com/uuidjs/uuid#getrandomvalues-not-supported");return v(x)}var C=/^(?:[0-9a-f]{8}-[0-9a-f]{4}-[1-5][0-9a-f]{3}-[89ab][0-9a-f]{3}-[0-9a-f]{12}|00000000-0000-0000-0000-000000000000)$/i;for(var T=[],R=0;R<256;++R)T.push((R+256).toString(16).substr(1));function N(e){var t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:0,r=(T[e[t+0]]+T[e[t+1]]+T[e[t+2]]+T[e[t+3]]+"-"+T[e[t+4]]+T[e[t+5]]+"-"+T[e[t+6]]+T[e[t+7]]+"-"+T[e[t+8]]+T[e[t+9]]+"-"+T[e[t+10]]+T[e[t+11]]+T[e[t+12]]+T[e[t+13]]+T[e[t+14]]+T[e[t+15]]).toLowerCase();if(!function(e){return"string"==typeof e&&C.test(e)}(r))throw TypeError("Stringified UUID is invalid");return r}function P(e,t,r){var s=(e=e||{}).random||(e.rng||w)();if(s[6]=15&s[6]|64,s[8]=63&s[8]|128,t){r=r||0;for(var n=0;n<16;++n)t[r+n]=s[n];return t}return N(s)}
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */class A extends S{static get isAbstractHTTPError(){return!0}get statusCode(){if(e(this.constructor.statusCode))throw new ReferenceError(`${this.name} class need to reimplement static statusCode getter.`);return this.constructor.statusCode}set statusCode(e){throw new SyntaxError("Try to assign a read only property.")}}
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */class Pe extends A{static get statusCode(){return 507}get isInsufficientStorageError(){return!0}}
/**
 ...
 * @author [Tristan Valcke]{@link https://github.com/Itee}
 * @license [BSD-3-Clause]{@link https://opensource.org/licenses/BSD-3-Clause}
 */class Se extends A{static get statusCode(){return 500}get isInternalServerError(){return!0}}
/**
